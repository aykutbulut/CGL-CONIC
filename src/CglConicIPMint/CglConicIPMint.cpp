...
CglConicIPMint::CglConicIPMint()
  : param_(0) {
  param_ = new CglConicIPMintParam();
  solver_ = 0;
  srand(0);
}

// copy constructor
CglConicIPMint::CglConicIPMint(const CglConicIPMint & other) {
  // copy param_
...
CglConicIPMint & CglConicIPMint::operator=(const CglConicIPMint & rhs) {
  // copy param_
  param_ = new CglConicIPMintParam(*(rhs.getParam()));
  // copy solver
...
void CglConicIPMint::setParam(CglConicIPMintParam const & param) {
  param_ = new CglConicIPMintParam(param);
}
...
/// Clone
CglConicCutGenerator * CglConicIPMint::clone() const {
  CglConicIPMint * new_cutg = new CglConicIPMint(*this);
  return new_cutg;
}

/// Create C++ lines to get to current state
std::string CglConicIPMint::generateCpp( FILE * fp) {
  std::cerr << "GenerateCpp is not implemented yet!" << std::endl;
  throw std::exception();
  return std::string();
}

OsiConicSolverInterface * CglConicIPMint::getSolver() const {
  return solver_;
}
